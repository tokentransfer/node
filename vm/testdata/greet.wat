(module
  ...
  (type (;17;) (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)))
  (type (;18;) (func (param i64 i32) (result i32)))
  (type (;19;) (func (param i32 i64 i32 i32 i32)))
  (type (;20;) (func (param i32 i64 i64 i64 i32 i32)))
  ...
  (import "wasi_snapshot_preview1" "clock_time_get" (func $runtime.clock_time_get (type 13)))
  ...
  (import "env" "log" (func $main._log (type 0)))
  ...
  (func $runtime.lookupPanic (type 6)
    ...
    unreachable)
  (func $_reflect.Value_.Len (type 7) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
  ...
  (func $_reflect.rawType_.Size (type 2) (param i32) (result i32)
    ...
    call $runtime._panic
    unreachable)
  (func $reflect.loadValue (type 4) (param i32 i32) (result i32)
    (local i32 i32)
    loop  ;; label = @1
      local.get 1
      if  ;; label = @2
    ...
    local.get 3)
  (func $reflect.maskAndShift (type 7) (param i32 i32 i32) (result i32)
    i32.const -1
    i32.const 32
    local.get 2
    i32.const 3
    ...
    select
    i32.and)
  (func $_reflect.Value_.IsNil (type 7) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_reflect.rawType_.NumField (type 2) (param i32) (result i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_reflect.rawType_.rawField (type 1) (param i32 i32 i32)
  ...
  (func $_reflect.rawType_.stripPrefix (type 2) (param i32) (result i32)
    ...
    i32.const 5
    i32.shr_u)
  (func $reflect.readVarint (type 0) (param i32 i32)
    (local i32 i32 i32)
    loop  ;; label = @1
      local.get 1
      i32.load8_s
    ...
    local.get 3
    i32.store)
  (func $reflect.readStringSidetable (type 0) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_reflect.Value_.Complex (type 1) (param i32 i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_reflect.Value_.Float (type 15) (param i32 i32 i32) (result f64)
  ...
  (func $_reflect.Value_.Interface (type 9) (param i32 i32 i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_reflect.Value_.Pointer (type 7) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_runtime.gcBlock_.state (type 2) (param i32) (result i32)
    ...
    i32.const 3
    i32.and)
  (func $_runtime.gcBlock_.markFree (type 5) (param i32)
    (local i32)
    i32.const 84896
    i32.load
    local.get 0
    ...
    i32.and
    i32.store8)
  (func $runtime.growHeap (type 16) (result i32)
    (local i32 i32 i32)
    memory.size
    memory.grow
    i32.const -1
    ...
    local.get 1)
  (func $runtime.startMark (type 5) (param i32)
  ...
  (func $runtime.hashmapBinaryDelete (type 5) (param i32)
  ...
  (func $strconv.IsPrint (type 2) (param i32) (result i32)
    ...
    call $runtime.lookupPanic
    unreachable)
  (func $strconv.bsearch16 (type 7) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    local.get 2
    i32.const 65535
    i32.and
  ...
  (func $strconv.rightShift (type 0) (param i32 i32)
    ...
    i32.const 0
    i32.store offset=800)
  (func $strconv.formatDigits (type 17) (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 400
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $strconv.mult128bitPow10 (type 11) (param i32 i64 i32 i32)
    ...
    call $runtime._panic
    unreachable)
  (func $strconv.divisibleByPower5 (type 18) (param i64 i32) (result i32)
    (local i32 i64)
    block  ;; label = @1
      local.get 0
      i64.eqz
    ...
    local.get 2)
  (func $strconv.formatDecimal (type 19) (param i32 i64 i32 i32 i32)
    (local i32 i64 i64)
    local.get 4
    i32.const 3
    i32.shl
  ...
  (func $strconv.mult64bitPow10 (type 9) (param i32 i32 i32 i32)
    ...
    call $runtime._panic
    unreachable)
  (func $strconv.ryuDigits (type 20) (param i32 i64 i64 i64 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
    ...
    call $runtime.slicePanic
    unreachable)
  (func $strconv.divmod1e9 (type 21) (param i32 i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $strconv.ryuDigits32 (type 10) (param i32 i32 i32 i32 i32 i32 i32)
    ...
    call $runtime.nilPanic
    unreachable)
  (func $_*fmt.pp_.fmt0x64 (type 12) (param i32 i64 i32)
    (local i32 i32)
    local.get 0
    i32.const 40
    i32.add
    ...
    i32.and
    i32.store8)
  (func $_*fmt.fmt_.fmtInteger (type 11) (param i32 i64 i32 i32)
  ...
  (func $_*fmt.pp_.fmtBool (type 0) (param i32 i32)
    ...
    i32.const 5
    call $_*fmt.fmt_.padString)
  (func $_*fmt.fmt_.padString (type 1) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_*fmt.pp_.fmtFloat (type 23) (param i32 f64 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_*fmt.buffer_.writeString (type 1) (param i32 i32 i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_*fmt.fmt_.writePadding (type 0) (param i32 i32)
    ...
    call $runtime.nilPanic
    unreachable)
  (func $_*fmt.pp_.fmtInteger (type 12) (param i32 i64 i32)
    local.get 0
    i32.const 44
    i32.add
    i32.load8_u
    ...
    local.get 2
    call $_*fmt.fmt_.fmtInteger)
  (func $_*fmt.pp_.fmtString (type 1) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 96
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_*fmt.pp_.handleMethods (type 2) (param i32) (result i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 128
    i32.sub
  ...
  (func $_*fmt.pp_.printValue (type 8) (param i32 i32 i32 i32 i32)
                                                                ...
                                                                block  ;; label = @31
                                                                  block  ;; label = @32
                                                                    block  ;; label = @33
                                                                      ...
                                                                      select
                                                                      local.tee 6
                                                                      br_table 0 (;@33;) 1 (;@32;) 2 (;@31;) 3 (;@30;) 4 (;@29;) 5 (;@28;) 7 (;@26;) 11 (;@22;) 9 (;@24;) 10 (;@23;) 12 (;@21;) 14 (;@19;) 8 (;@25;) 15 (;@18;) 16 (;@17;) 17 (;@16;) 18 (;@15;) 19 (;@14;) 24 (;@9;) 24 (;@9;) 26 (;@7;) 23 (;@10;) 25 (;@8;) 25 (;@8;) 24 (;@9;) 20 (;@13;) 21 (;@12;) 22 (;@11;)
                                                                    end
                                                                    local.get 4
                                                                    i32.eqz
                                                                    if  ;; label = @33
    ...
    i32.add
    global.set $__stack_pointer)
  (func $fmt.Sprint (type 1) (param i32 i32 i32)
  ...
  (func $greet (type 0) (param i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $main.greeting (type 1) (param i32 i32 i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const -64
    i32.add
    ...
    i32.sub
    global.set $__stack_pointer)
  (func $main.stringToPtr (type 1) (param i32 i32 i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
